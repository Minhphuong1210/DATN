    ...
    <div className=" bg-black text-white mt-32">
      ...
      <div className="ml-32 flex">
        ...
        <div className="ml-40">
          ...
          <div className=" flex ">
            <input
              className="w-full rounded-full border border-gray-300 py-2 pl-4 pr-24 focus:outline-none text-black  focus:ring-2 focus:ring-blue-500"
              type="text"
              placeholder="Nhập địa chỉ Email..."
            />
            <button className=" w-32 bg-white text-black rounded-full hover:bg-slate-400 ">
              Đăng ký
            </button>
          </div>
        </div>
