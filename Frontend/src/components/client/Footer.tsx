...
const Footer = () => {
    return (
        <div className="border border-separate border-slate-300 clear-both bg-black text-white mt-32">
            <div className="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                    <div className="flex flex-col flex-shrink-0">
                        ...
                        <p className="text-sm leading-none  mt-4">Copyright © 2021 Modern Men</p>
                    ...
                    <div className="sm:ml-0 ml-8 text-white">
                        <h2 className="text-base font-semibold leading-4 text-white">GIỚI THIỆU MODERN MEN</h2>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white cursor-pointer">Giới thiệu</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Blog</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Hệ thống cửa hàng</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Liên hệ với Modern Men</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Chính sách bảo mật</p>
                    </div>
                    <div>
                        <h2 className="text-base font-semibold leading-4 text-white">HỖ TRỢ KHÁCH HÀNG</h2>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Hỏi đáp</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Chính sách vận chuyển</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Hướng dẫn thanh toán</p>
                        <p className="hover:text-gray-500 text-base leading-4 mt-6  cursor-pointer">Hướng dẫn mua hàng</p>
                    </div>
                    <div className="mt-10 lg:block hidden">
                        <label className="text-xl font-medium leading-5 abc@gmail.com">Get updates</label>
