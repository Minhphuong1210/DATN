                ...
                <div class="card-body">
                    ...
                    {{-- <form action="{{ route('admins.promotion.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <input type="text" name="code" class="form-control mt-2" placeholder="Vui lòng nhập tên">
                            @error('code')
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="minimum_spend" class="form-control mt-2">
                            @error('minimum_spend')
                                <span style="color:red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="usage_limit" class="form-control mt-2">
                            @error('usage_limit')
                                <span style="color:red">{{ $message }}</span>
                            @enderror
                        </div>
